...
class Client():
    ...
    def DOWNLOAD(self, file_dir_name):
        ...
        try:
            ...
            while True:
                ...
                f.write(bytes)
            f.close()
            self.gui_client.popupmsg("Success", "Download success")
        except Exception as e:
            print 'Error ' + str(e)
            traceback.print_exc()
        finally:
    ...
    def UPLOAD(self, file_dir_name):
        ...
        try:
            ...
            self.gui_client.popupmsg("Success", "Upload success")
        except Exception as e:
            print 'Error ' + str(e)
            self.gui_client.popupmsg("Error", str(e))
            traceback.print_exc()
        finally:
            self.data_socket.close()
    ...
    def DELETE(self, to_delete):
        ...
        try:
            ...
            self.receive_conn_response()
            self.gui_client.popupmsg("Success", "Delete success")
        except Exception as e:
            print 'Error ' + str(e)
            self.gui_client.popupmsg("Error", str(e))
            traceback.print_exc()
    ...
    def SHARE(self, share_to, to_share):
        ...
        try:
            ...
            self.receive_conn_response()
            self.gui_client.popupmsg("Success", "Share success")
        except Exception as e:
            print 'Error ' + str(e)
            self.gui_client.popupmsg("Error", str(e))
            traceback.print_exc()
